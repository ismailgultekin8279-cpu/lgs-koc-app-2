...
import { bulkUpsertExamResults } from '../lib/endpoints';
import { api } from '../services/api'; // Keep for generatePlan for now, or move to endpoints later
...
export default function ExamEntryPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await bulkUpsertExamResults(payload);
            setStatus('success');
            ...
            console.error(err);
            setStatus('error');
            // Show more friendly error if possible
